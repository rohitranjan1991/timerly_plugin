...
data class CreateForegroundServiceRequest(val serviceId: Int = 0, val widgetType: Int, val title: String, val message: String, val bigContentTitle: String?, val bigContentMessage: String?, val autoCancel: Boolean? = false, val priority: Int? = 4, val setFullScreenIntent: Boolean? = false,
...
data class GenericRequest2(val id: Int, var arg1: Any)